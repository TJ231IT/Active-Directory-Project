...
I was able to create a new user in the ACtive Directory Users and Computers. From here, I could create users, change/reset passwords, and even unlock/disable users. I decided to create a User named James Bond with the username jbond. Bond will be the user that can access the Test Machiine. I was also able to create a temporary password, and enabled it so Bond would have to create a new password after logging on. 
